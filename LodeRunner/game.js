...
function supported(c, r) {
    ...
    // A drilled brick is a pit, not a shaft: whatever drops in lands in it, even
    // where the floor is a single tile thick with open space underneath.
    if (here === HOLE) return true;
