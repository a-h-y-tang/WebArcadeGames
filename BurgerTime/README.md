...
- Enemies enter one at a time and pause for a beat whenever they step off a
  ladder — and you walk and climb faster than they do, so you can outrun them.
...
| `tests/burgertime.spec.js` | Playwright suite (69 tests) |
